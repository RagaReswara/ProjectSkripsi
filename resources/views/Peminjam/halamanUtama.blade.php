    ...
    <div class="p-4 sm:ml-64">
      ...
      <div class="p-4 border-2 border-gray-200 border-solid rounded-lg dark:border-gray-700">
            ...
            <div class="flex-1 gap-4 mb-4">
              <p class="text-2xl text-gray-400 dark:text-black mr-4 mb-5">Silahkan pilih tanggal</p>
              ...
              <div class="flex items-center h-18 rounded bg-gray-50 dark:bg-gray-800 ">
                ...
                <!-- DATE PICKER -->
                      <div class="relative max-w-sm mr-10">
                        ...
                        <input datepicker datepicker-autohide type="text" datepicker-format="dd/mm/yyyy" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Select date" id="datepicker">
                      </div>
        ...
        <!-- JADWAL -->
            <div class="flex-1 gap-4 mb-4">
                ...
                <div id="slot" class="flex gap-2">
                  ...
                  <div class="w-1/7">
                    <div class="flex group-disabled:inset-72 items-center h-24 rounded bg-gray-50 dark:bg-gray-800 pl-4">
                        <p class="text-2xl text-gray-400 dark:text-gray-500 mr-4">
        ...
        function slot() {
          ...
          .then(data=>{
            ...
            <div class="w-1/7">
              <div class="flex items-center h-24 rounded bg-gray-50 dark:bg-gray-800 pl-4">
                <p class="text-2xl text-gray-400 dark:text-gray-500 mr-4 ">
                    <a href="http://127.0.0.1:8000/form" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group ${item.status == 1 ? 'dark:hover:bg-red-700 pointer-event-none group-disabled:inset-72' : 'dark:hover:bg-gray-700'}">
