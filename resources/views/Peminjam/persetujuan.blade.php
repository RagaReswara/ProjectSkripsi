...
<div class="p-4 sm:ml-64">
        ...
        <div class="p-4 border-2 border-gray-200 border-solid rounded-lg dark:border-gray-700">
            ...
            <div class="flex items-center h-10 rounded bg-gray-50 dark:bg-gray-800 mb-5">
                ...
                <span class="flex items-center text-sm font-medium text-gray-900 dark:text-white me-3"><span class="flex w-2.5 h-2.5 bg-yellow-300 rounded-full me-1.5 flex-shrink-0"></span>Menunggu Disetujui</span>
                        ...
                        data.data.forEach((item) => {
                            ...
                            `
                                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                    ...
                                    <td class="px-6 py-4">
                                        ${item.special_status == 0 ? 'Belum Mulai' : item.special_status == 1 ? 'Sedang Dimulai' : 'Selesai'}
                                    </td>
