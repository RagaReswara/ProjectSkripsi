...
<div class="p-4 sm:ml-64">
        ...
        <div class="p-4 border-2 border-gray-200 border-solid rounded-lg dark:border-gray-700">
            ...
            <div class="w-3/12 dark:bg-gray-600 dark:border-gray-500 rounded-xl" id="alertContainer"></div>  
        ...
        <script>
            ...
            //         method:'POST', headers:{'Content-Type':'application/json'}, body:JSON.stringify({id_form:idForm, catatan:simpanCatatan})
            //     })
            //     .then(response => response.json())
            //     .then(data => {
            //         fetch('http://127.0.0.1:8000/api/mulaiPinjam', {
            //         method:'POST', headers:{'Content-Type':'application/json'}, body:JSON.stringify({id:idForm, catatan:simpanCatatan})
            //         })
            //         .then(response => response.json())
            //         .then(data => {

            //             alert("Berhasil Kirim Catatan ke peminjam")
            //         })
            //     })
            ...
            function kirimGmail() {
                ...
                let button = document.getElementById('kirimPesanBtn');
                
                // Disable the button and change its content to loading spinner
                button.disabled = true;
                button.innerHTML = `
                <svg aria-hidden="true" class="inline w-8 h-8 item-center justify-center text-gray-200 animate-spin dark:text-gray-600 fill-gray-600 dark:fill-gray-300" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                .then(response => response.json())
                .then(data => {
                    return fetch('http://127.0.0.1:8000/api/mulaiPinjam', {
                        method: 'POST',
                        headers: {'Content-Type': 'application/json'},
                ...
                .then(data => {
                    ...
                    successAlert.innerHTML = `
                        <span class="font-medium">Success alert!</span> Berhasil mengirim catatan ke peminjam.
                    `;
